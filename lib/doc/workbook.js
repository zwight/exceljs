...
class Workbook {
  ...
  addCellImage(data) {
    ...
    this.media.push(Object.assign({}, model, image.model));

    return {id, value: image.value};
  }

  getCellImages() {
    return this.media.filter(d => d.type === 'cellimage');
  }

  getImages() {
    return this.media.filter(d => d.type === 'image');
  }
